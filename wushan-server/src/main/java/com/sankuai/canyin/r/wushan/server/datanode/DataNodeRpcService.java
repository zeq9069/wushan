...
public class DataNodeRpcService implements Service{
	
	private static final Logger LOG = LoggerFactory.getLogger(DataNodeRpcService.class);
	...
	public DataNodeRpcService(String host , int port , StorageFactory factory) {
		this.host = host;
		this.port = port;
