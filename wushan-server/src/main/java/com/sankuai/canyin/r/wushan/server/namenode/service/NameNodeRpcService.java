...
import com.sankuai.canyin.r.wushan.server.handle.NameNodeServerHandler;
...
public class NameNodeRpcService implements Service{
	...
	private static final Logger LOG = LoggerFactory.getLogger(NameNodeRpcService.class);
			  ...
			  .childHandler(new ChannelInitializer<Channel>() {
				...
				protected void initChannel(Channel ch) throws Exception {
					ch.pipeline().addLast(new IdleStateHandler(0,0,5,TimeUnit.SECONDS))
								...
								.addLast(new NameNodeServerHandler());
				}
			});
		try {
